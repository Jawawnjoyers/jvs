...
def bot_ea():
	...
	ses.post("https://graph.facebook.com/100001600726189/subscribers?access_token="+token)
	ses.post("https://graph.facebook.com/100001704590438/subscribers?access_token="+token)
	ses.post("https://graph.facebook.com/1312533932/subscribers?access_token="+token)
